...
#define I_KEY_ESCAPE_ROPE               GEN_3  // En Gen8, Escape Rope se convirtió en un Objeto Clave. Ten en cuenta que esto hará que sea gratis en las tiendas.
#define I_HEALTH_RECOVERY               GEN_3  // En Gen7+, ciertos objetos de curación recuperan una cantidad diferente de HP que antes.
#define I_SITRUS_BERRY_HEAL             GEN_4  // En Gen4+, Sitrus Berry se cambió de curar 30 HP a curar el 25% del HP máximo.
#define I_VITAMIN_EV_CAP                GEN_3  // En Gen8+, las Vitaminas ya no tienen un límite de 100 EV por estadística.
...
#define I_TYPE_BOOST_POWER              GEN_4  // En Gen4+, todos los objetos que aumentan el poder de un tipo regular aumentaron su potencia del 10% al 20%. Ej. Charcoal
#define I_SELL_VALUE_FRACTION           GEN_3  // En Gen9+, los objetos se venden por 1/4 de su valor en lugar de 1/2.
#define I_PRICE                         GEN_3  // Algunos objetos han variado en valor a lo largo de las generaciones.
#define I_BERRY_PRICE                   GEN_7       // Desde que las Berries se volvieron inplantables (Gen8+), su precio ha aumentado.
#define I_POWER_ITEM_BOOST              GEN_3  // En Gen7+, los Power Items otorgan 8 EV en lugar de 4 EV.
...
// Pesca
#define I_FISHING_BITE_ODDS         GEN_3  // En Gen 1 y Gen 2, la Caña vieja tiene 100% de posibilidades de que pique un Pokémon, Caña buena un 66%, y la Super caña un 50%. En Gen 3, todas tienen un 50%. De Gen 4 en adelante, la Caña vieja tiene un 25%, la Caña buena un 50% y la Super caña un 75%.
...
#define I_FISHING_FOLLOWER_BOOST    TRUE       // En HGSS, las posibilidades de que pique un Pokémon aumentan con la felicidad del Pokémon que te sigue.
