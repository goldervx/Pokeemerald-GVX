...
#define P_UPDATED_TYPES             GEN_3  // Desde Gen 6, varios Pokémon cambiaron a ser parcialmente o completamente de tipo Hada.
#define P_UPDATED_STATS             GEN_3  // Desde Gen 6, las estadísticas de los Pokémon se actualizan con cada generación.
#define P_UPDATED_ABILITIES         GEN_3  // Desde Gen 6, ciertos Pokémon tienen sus habilidades cambiadas.
#define P_UPDATED_EGG_GROUPS        GEN_3  // Desde Gen 8, ciertos Pokémon han ganado nuevos grupos de huevos.
#define P_UPDATED_FRIENDSHIP        GEN_3  // Desde Gen 8, la amistad base de ciertos Pokémon fue cambiada.
#define P_UPDATED_EVS               GEN_3  // Algunos Pokémon han recibido actualizaciones de EV después de su introducción.
#define P_UPDATED_EXP_YIELDS        GEN_3  // Desde Gen 5, algunos Pokémon han recibido cambios en la Experiencia base.

// Aprendizajes
#define P_LVL_UP_LEARNSETS          GEN_3  // Elige qué conjunto de Aprendizajes por Nivel usar.
...
#define P_EVOLUTION_LEVEL_1_LEARN   GEN_3  // En Gen 8+, Pokémon que evolucionen al nivel 1 no aprenden los ataques de ese nivel, mientras que antes sí lo hacían.

// Configuración de evolución
#define P_FRIENDSHIP_EVO_THRESHOLD   GEN_3  // Desde Gen 8, los Pokémon que evolucionan por amistad evolucionan en o arriba de 160 de amistad en lugar de 220.

// Configuración de cría
#define P_NIDORAN_M_DITTO_BREED         GEN_3  // Desde Gen 5, cuando Nidoran♂ cría con Ditto puede producir descendencia Nidoran♀. Antes, solo producía descendencia masculina. Este cambio también se aplica a Volbeat.
#define P_INCENSE_BREEDING              GEN_3  // Desde Gen 9, los Pokémon Bebés de generaciones cruzadas no requieren que los padres sostengan Incienso para ser obtenidos mediante cría.
#define P_EGG_HATCH_LEVEL               GEN_3  // Desde Gen 4, los Pokémon nacerán de los huevos en el nivel 1 en lugar de 5.
#define P_BALL_INHERITING               GEN_3  // Desde Gen 6, los Huevos del Centro de Crianza heredarán la Pokébola de su madre. Desde Gen 7 en adelante, el padre también puede transmitirla siempre que sea de la misma especie que la madre.
#define P_TM_INHERITANCE                GEN_3  // Desde Gen 6, el padre ya no transmite MTs al bebé.
#define P_MOTHER_EGG_MOVE_INHERITANCE   GEN_3  // Desde Gen 6, la madre también puede transmitir Movimientos de Huevo.
#define P_NATURE_INHERITANCE            GEN_3  // En Gen 3, Everstone otorga a Ditto y a las madres un 50% de probabilidad de transmitir la Naturaleza. Desde Gen 4, cualquiera puede transmitir la naturaleza. Desde Gen 5, la probabilidad es del 100%.
#define P_ABILITY_INHERITANCE           GEN_3  // En B2W2, un Pokémon hembra tiene un 80% de probabilidad de transmitir su habilidad si se cría con un macho. Desde Gen 6, la probabilidad es del 80% para habilidad normal y 60% para Habilidad Oculta, y cualquiera puede transmitir sus habilidades si se cría con Ditto. NOTA: Efecto de BW: Se ha omitido la probabilidad del 60% de transmitir HA y aleatorio para habilidad normal.
#define P_EGG_MOVE_TRANSFER             GEN_3  // A partir de Gen 8, si dos Pokémon de la misma especie están juntos en el Centro de Crianza, uno conoce un Movimiento de Huevo y el otro tiene un espacio vacío, el otro Pokémon recibirá el Movimiento de Huevo en el espacio vacío. En Gen 9, si un Pokémon sostiene una Hierba Espejo, recibirá Movimientos de Huevo del otro independientemente de la especie.
...
#define P_SHEDINJA_BALL             GEN_3  // Desde Gen 4, Shedinja requiere una Pokébola para su evolución. En Gen 3, Shedinja hereda la Pokébola de Nincada.
#define P_KADABRA_EVERSTONE         GEN_3  // Desde Gen 4, Kadabra puede evolucionar incluso cuando sostiene un Everstone.
...
#define P_LEGENDARY_PERFECT_IVS          GEN_3  // Desde Gen 6, los Legendarios, Mitológicos y Bestias Ultra encontradas en la naturaleza o recibidas como regalos tienen al menos 3 IVs perfectos.
#define P_EV_CAP                         GEN_3  // Desde Gen 6, el máximo de EVs por estadística es 252 en lugar de 255.
#define P_SHOW_TERA_TYPE                 GEN_3       // Desde Gen 9, el Tipo Tera se muestra en la pantalla de resumen.
#define P_TM_LITERACY                    GEN_3  // Desde Gen 6, Pokémon que no pueden aprender MTs pueden aprender MTs que enseñan movimientos que están en sus aprendizajes por nivel.
...
#define P_EGG_CYCLE_LENGTH               GEN_3  // Desde Gen 8, los ciclos de huevo toman la mitad de pasos que antes.
